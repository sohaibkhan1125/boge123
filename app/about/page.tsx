...
const About = () => {
  return (
    ...
    <div className='p-5'>
      ...
      <p>If you have additional questions or require more information about our About Us Page, do not hesitate to contact us through email at <b>admin@gallantinsure.com
      </b></p>
      ...
      <p>Hi in the above paragraph you know about the website properly and now I am going to provide my contact details.</p>
      ...
      <p>If you want to contact us then you can email us at admin@gallantinsure.com
      also, you can contact us by our contact us form. Go to homepage <a href="https://localhost:3000">AI Content Generator</a>.</p>
      <center>
