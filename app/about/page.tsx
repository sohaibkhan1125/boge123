...
const About = () => {
  return (
    <section>
        <TopMenu/>
    <div className='p-5'>
        <h1 className='font-bol text-4xl text-center p-2'>About Us</h1>
      <p>Hello, Dear friends, Welcome to AI Content Generator also, we are happy you want to know something more about our site</p>
      ...
      <p>If you have additional questions or require more information about our About Us Page, do not hesitate to contact us through email at <b>sohaibniazi181@gmail.com</b></p>
      ...
      <p>Basically, we focus on the AI Content Generator niche so, our main priority is to search for new content and present it in front of you to learn something new. </p>
      <h3><b>What is our Service?</b></h3>
      <p>We are mainly focused on the AI Content Generator category so, we provide AI Content Generator related content if you are interested in the AI Content Generator category then you can visit daily to get more latest information.</p>
      <p>AI Content Generator provide lot of tools that will help you to generate different types of content easily.</p>
      <p>On our website AI Content Generator you get can all AI Content Generator related information also, we focus on many other categories and we hope you like also, the content of other categories that are maintained on our website. So, you can visit our website homepage to know all category details here you can visit our homepage Click here<a href="https://localhost:3000">AI Content Generator</a>.</p>
      <p>Also, we provide a Notification update service you can join by email and other Social Media Platforms, and all Links you can get on the Homepage visit now. <a href="https://localhost:3000">AI Content Generator</a></p>
      <h3><b>About AI Content Generator</b></h3>
      <p>As you can see already we mention what is our goal and Service again we repeat that we mainly focus on AI Content Generator Category to help people.</p>
      <p>This Website is Created By AI Content Generator to help people because many people are still spending hours of time to get exact information so, this is the only motive to create <a href="https://localhost:3000">AI Content Generator</a> to help people and provide them a better web experience. Also, This About Us Page is Generated With <a href="https://soumyahelp.com">Soumya help</a>.</p>
      ...
      <h3><b>Admin's Statement for AI Content Generator</b></h3>
      ...
      <p>Hi, this Sohaib, in the above paragraph you know about the website properly and now I am going to provide my contact details.</p>
      ...
      <p>Finally, this is our complete about us page about details are showing what is the motive to create AI Content Generator. Also, this page is generated by Soumya Help <a href="https://soumyahelp.com/about-us-generator/">About Us Generator</a></p>
      <p>If you want to contact us then you can email us at admin@asadseotools.com also, you can contact us by our contact us form. Go to homepage <a href="https://localhost:3000">AI Content Generator</a>.</p>
      <center>
