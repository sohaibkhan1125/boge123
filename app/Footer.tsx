        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
                ...
                <ul className="text-lg text-center sm:flex items-cente justify-center gap-14 lg:gap-10 xl:gap-14 transition-all duration-500">
                    ...
                    <li  className="sm:my-0 my-2">
                        <p   className="text-white hover:text-gray-400">Privacy Policy</p>
                        </li>
                        </Link>
                </ul>
                <div className="flex  space-x-4 sm:justify-center  ">
                    <a href="javascript:;"  className="w-9 h-9 rounded-full bg-gray-800 flex justify-center items-center hover:bg-indigo-600">
